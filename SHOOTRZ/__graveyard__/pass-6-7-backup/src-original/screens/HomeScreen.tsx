...
export const HomeScreen: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  const quickActions = [
    { title: 'Analyze Shot', icon: 'videocam', color: SHOOTRZ_THEME.colors.primary, screen: 'Analyze' },
    { title: 'Browse Drills', icon: 'basketball', color: SHOOTRZ_THEME.colors.secondary, screen: 'Drills' },
    { title: 'Start Workout', icon: 'barbell', color: SHOOTRZ_THEME.colors.accent, screen: 'Workouts' },
    { title: 'Chat with Coach J', icon: 'chatbubbles', color: SHOOTRZ_THEME.colors.primaryLight, screen: 'Coach J' },
  ];
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const avgScore = analysisHistory.length > 0 ? Math.round(totalScore / analysisHistory.length) : 0;
  ...
  const calculateDayStreak = (analysisHistory: any[], workoutHistory: any[], drillCompletions: any[]): number => {
      ...
      <View style={styles.section}>
        ...
        <View style={styles.actionsGrid}>
          <View style={styles.actionRow}>
            ...
            >
              <View style={[styles.actionIconContainer, { backgroundColor: quickActions[0].color + '20' }]}>
                <Ionicons name={quickActions[0].icon as any} size={28} color={quickActions[0].color} />
              </View>
              <Text style={styles.actionTitle} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.85}>{quickActions[0].title}</Text>
            ...
            >
              <View style={[styles.actionIconContainer, { backgroundColor: quickActions[1].color + '20' }]}>
                <Ionicons name={quickActions[1].icon as any} size={28} color={quickActions[1].color} />
              </View>
              <Text style={styles.actionTitle} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.85}>{quickActions[1].title}</Text>
          ...
          <View style={styles.actionRow}>
            ...
            >
              <View style={[styles.actionIconContainer, { backgroundColor: quickActions[2].color + '20' }]}>
                <Ionicons name={quickActions[2].icon as any} size={28} color={quickActions[2].color} />
              </View>
              <Text style={styles.actionTitle} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.85}>{quickActions[2].title}</Text>
            ...
            >
              <View style={[styles.actionIconContainer, { backgroundColor: quickActions[3].color + '20' }]}>
                <Ionicons name={quickActions[3].icon as any} size={28} color={quickActions[3].color} />
              </View>
              <Text style={styles.actionTitle} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.85}>{quickActions[3].title}</Text>
          ...
          <GradientCard key={index} style={styles.activityItem}>
            ...
            <View style={styles.activityContent}>
              <Text style={styles.activityTitle}>
                {activity.type === 'Analysis' ? `Shot Analysis - ${activity.score}%` :
                 activity.type === 'Drill' ? activity.name :
                 activity.name}
              </Text>
            ...
            {activity.score != null && activity.score > 0 ? (
              <View style={[styles.scoreBadge, { 
                backgroundColor: activity.score >= 80 ? '#4CAF50' : 
       ...
       >
         ...
         <View style={styles.tipContent}>
           ...
           <Text style={styles.tipText}>
             Keep your elbow aligned with the basket and follow through with your shooting hand for better accuracy.
           </Text>
         </View>
