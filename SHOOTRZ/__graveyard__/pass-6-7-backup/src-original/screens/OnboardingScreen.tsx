  ...
  const renderStep = () => {
    ...
    return (
      <View style={styles.stepContainer}>
        <Ionicons name={step.icon as any} size={64} color={SHOOTRZ_THEME.colors.primary} style={{ marginBottom: SHOOTRZ_THEME.spacing.lg }} />
            ...
            {(['beginner', 'intermediate', 'advanced'] as const).map((level) => (
              ...
              >
                ...
                <Text style={styles.optionDescription}>
                  {level === 'beginner' ? 'Learning fundamentals' :
                   level === 'intermediate' ? 'Improving consistency' :
