...
export const WorkoutsScreen: React.FC = () => {
  ...
  const handleStartWorkout = async (workoutId: string) => {
    if (activeWorkouts.includes(workoutId)) {
      ...
      Alert.alert(
        'Complete Workout?',
        `Mark "${workout?.name}" as completed?`,
        [
          ...
          <View style={styles.workoutHeader}>
            <View style={styles.workoutInfo}>
              ...
              <View style={styles.workoutMeta}>
                ...
                <View style={styles.workoutMeta}>
                  <Ionicons name="basketball" size={14} color={SHOOTRZ_THEME.colors.textSecondary} />
      ...
      <View style={styles.quickWorkouts}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => {
            Alert.alert(
              '5-Minute Warm-up',
              'Start your warm-up routine now?',
              [
                { text: 'Cancel', style: 'cancel' },
                { text: 'Start', onPress: () => Alert.alert('Timer Started', 'Your 5-minute warm-up has started!') },
              ]
            );
          }}
        >
          <Ionicons name="flash" size={32} color={SHOOTRZ_THEME.colors.accent} style={{ marginRight: SHOOTRZ_THEME.spacing.md }} />
        ...
        <TouchableOpacity 
          ...
          onPress={() => {
            Alert.alert(
              'Shooting Session',
              'Start your shooting practice now?',
              [
                { text: 'Cancel', style: 'cancel' },
                { text: 'Start', onPress: () => Alert.alert('Timer Started', 'Your shooting session has started!') },
              ]
            );
          }}
        >
          <Ionicons name="basketball" size={32} color={SHOOTRZ_THEME.colors.primary} style={{ marginRight: SHOOTRZ_THEME.spacing.md }} />
          <View style={styles.quickWorkoutContent}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => {
            Alert.alert(
              'Conditioning',
              'Start your conditioning workout now?',
              [
                { text: 'Cancel', style: 'cancel' },
                { text: 'Start', onPress: () => Alert.alert('Timer Started', 'Your conditioning workout has started!') },
              ]
            );
          }}
        >
          <Ionicons name="barbell" size={32} color={SHOOTRZ_THEME.colors.secondary} style={{ marginRight: SHOOTRZ_THEME.spacing.md }} />
          <View style={styles.quickWorkoutContent}>
