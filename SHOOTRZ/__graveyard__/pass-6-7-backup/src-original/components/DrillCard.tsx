...
export const DrillCard: React.FC<DrillCardProps> = ({ drill, onPress }) => {
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      case 'beginner': return SHOOTRZ_THEME.colors.secondary;
      case 'intermediate': return SHOOTRZ_THEME.colors.primary;
      case 'advanced': return SHOOTRZ_THEME.colors.warning;
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={onPress}>
      <View style={styles.header}>
        ...
        <View style={[styles.difficulty, { backgroundColor: getDifficultyColor(drill.difficulty) }]}>
