...
export const AngleGraph: React.FC<AngleGraphProps> = ({ 
  ...
  const [selectedMetric, setSelectedMetric] = useState<'elbow' | 'knee' | 'release' | 'alignment'>('elbow');
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.dataPoint,
                    {
                      ...
                      borderColor: selectedFrame === point.frame ? SHOOTRZ_THEME.colors.text : 'transparent',
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.legend}>
        ...
        <View style={styles.legendItem}>
          <View style={[styles.legendColor, { backgroundColor: SHOOTRZ_THEME.colors.success, opacity: 0.3 }]} />
