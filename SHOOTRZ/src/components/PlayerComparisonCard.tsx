...
export const PlayerComparisonCard: React.FC<PlayerComparisonCardProps> = ({ player, onPress }) => {
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.similarityContainer}>
            <View
              style={[
                styles.similarityCircle,
                { borderColor: getSimilarityColor(player.similarity) },
              ]}
            >
              <Text
                style={[styles.similarityText, { color: getSimilarityColor(player.similarity) }]}
              >
                {player.similarity}%
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    minWidth: 280,
    maxWidth: 320,
    shadowColor: SHOOTRZ_THEME.colors.background,
    shadowOffset: {
      width: 0,
      height: 2,
    },
  ...
  playerName: {
    fontSize: 18,
    fontWeight: '700',
    color: SHOOTRZ_THEME.colors.background,
    marginBottom: 2,
  },
  position: {
    fontSize: 14,
