      ...
      >
        ...
        <View style={styles.metricsContainer}>
          ...
          <View style={styles.directionContainer}>
            <Ionicons name={getDirectionIcon() as any} size={20} color={getDirectionColor()} />
            <Text style={[styles.improvementText, { color: getDirectionColor() }]}>
              {improvementNeeded.toFixed(1)}°{' '}
              {getImprovementDirection() === 'up' ? 'increase' : 'decrease'} needed
            </Text>
          </View>
        ...
        <View style={styles.progressContainer}>
          ...
          <Text style={styles.progressText}>{Math.round((current / target) * 100)}% of target</Text>
        </View>
